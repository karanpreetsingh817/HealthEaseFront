    ...
    <>
      ...
      >
        <Link
          ...
          <span className="absolute top-6 right-6 z-20 inline-flex items-center justify-center rounded-full bg-dark py-2 px-4 text-sm font-semibold capitalize text-white hover:bg-green hover:text-dark">
            {qualification}
          </span>
            ...
            <div className="mr-5 flex items-center border-r border-body-color border-opacity-10 pr-5 dark:border-white dark:border-opacity-10 xl:mr-3 xl:pr-3 2xl:mr-5 2xl:pr-5">
              <div className="mr-4">
                <div className="relative h-10 w-10 overflow-hidden rounded-full">
                  <Image src={profileImg.url} alt="author" fill className="hover:scale-110  transition duration-300 ease-in-out"/>
                </div>
              </div>
