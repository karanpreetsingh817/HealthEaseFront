...
const AboutPage = () => {
    ...
    const handleSubmit = async (el) => {
        try {
            ...
            const res = await axios.patch(`${process.env.NEXT_PUBLIC_API_URL}patient/${user._id}`, { email, name }, {
                headers: {
                    "authorization": `Bearer ${Token}`,
                    "Content-Type": "application/json"
                },
    ...
    return (
        <>
            ...
            <section className="py-16 md:py-20 lg:py-28 ml-16 mr-16">
                ...
                <div className="container  bg-white  bg-opacity-80 backdrop-blur-md  pb-12  ">
