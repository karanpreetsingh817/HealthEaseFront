            ...
            <section className="py-16 md:py-20 lg:py-28">
                ...
                <div className="container  bg-fs    ">
                        ...
                        <div className="w-full px-4 lg:w-2/3 mt-12 mb-10 rounded-md  p-6 lg:mt-0 ">
                            <div className="wow fadeInUp max-w-[470px]" data-wow-delay=".2s">
                                ...
                                <div className="mb-9 ml-8">
                                    ...
                                    <button className=" w-full justify-center rounded-md bg-primary py-4 px-9 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp inline-block mt-4">
                            Make Appointment
                        </button>
                                </div>
                            </div>
                    ...
                    <div className="flex justify-end  pb-8">
                        ...
                        <button className="w-1/6 justify-center rounded-md bg-primary py-4 px-9 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp inline-block mr-8">
                           Add Review
                        </button>
                        <button  onClick={handleAllR} className=" w-1/6 justify-center rounded-md bg-primary py-4 px-9 text-base font-medium text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp inline-block">
                            All Review
                        </button>
