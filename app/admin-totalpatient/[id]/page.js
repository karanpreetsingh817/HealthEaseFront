...
const TotalDoctor = () => {
  ...
  const getInfo = async () => {
    ...
    try {
      const res = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}doctor/showOnePatient`, {
        headers: {
      ...
      toast.error('🦄 There Is Error While Fetching Data Of Patients', {
        position: "top-center",
        autoClose: 5000,
  ...
  const handleDelete = async () => {
    try {
      const res = await axios.delete(`${process.env.NEXT_PUBLIC_API_URL}doctor/deleteOne/${id}`, {
        headers: {
      ...
      toast.error('🦄 There Is Error While Delete the Patient Profile', {
        position: "top-center",
        autoClose: 5000,
        hideProgressBar: false,
        closeOnClick: true,
  ...
  return (
    <>
      ...
      <section className="py-16 md:py-20 lg:py-28 ml-16 mr-16">
        ...
        <div className="container   bg-[#F9F6EE] shadow-lg  bg-opacity-80 backdrop-blur-md  pb-8  ">
          ...
          <div className="-mx-4 flex flex-wrap  ">
            <div className="w-full px-4 lg:w-1/3">
              ...
              <div className="wow fadeInUp relative mx-auto mb-12  max-w-[500px] text-center lg:m-0 flex justify-center">
                ...
                <Image src={photo} alt="Doctor-profile-IMG" width={150} height={150} className="rounded-full mb-8 items-top mt-4 hover:scale-110  transition duration-300 ease-in-out" />
              ...
              <div className="flex items-start my-8 flex-col ml-8">
                ...
                >
                  <svg
                    ...
                    height="18"
                    viewBox="0 0 9 18"
                    className="fill-current  inline-block mr-8"
                  >
